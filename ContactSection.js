    ...
    <section id="contacto" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-xl font-semibold mb-4 text-blue-600">Información de Contacto</h3>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <span className="text-gray-700">info@servicioscarutos.com</span>
              </div>
              <div className="flex items-start">
                <svg className="w-6 h-6 text-blue-500 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start">
                ...
                <span className="text-gray-700">Calle Industrial #123, Zona Industrial, Ciudad</span>
              </div>
            </div>
          </div>
