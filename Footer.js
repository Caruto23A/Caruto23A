    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">Servicios Carutos</h3>
            <p className="text-gray-400">Soluciones integrales en ingeniería mecánica y diseño industrial.</p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>© {new Date().getFullYear()} Servicios Carutos. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
